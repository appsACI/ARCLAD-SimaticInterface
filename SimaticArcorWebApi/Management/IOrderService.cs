...
namespace SimaticArcorWebApi.Management
{
    public interface IOrderService
    {
        ...
        Task ProcessNewOperationAsync(WorkOrderOperationRevisionRequest prod, CancellationToken ct);
        ...
        Task<WorkOrderOperationParameterSpecification> UpdateCounterTrimCorte(string parameterId, CancellationToken ct);
