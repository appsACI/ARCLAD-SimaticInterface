...
namespace SimaticArcorWebApi.Management
{
    public interface ISimaticOrderService
    {
        ...
        Task<dynamic> CallCreateOrderFromOperationCommand(string id, string status, CancellationToken token);
        ...
        Task SetWorkOrderOperationParametersSpecificationAsync(WorkOrderOperationRevisionRequest prod, string verb, CancellationToken token);
