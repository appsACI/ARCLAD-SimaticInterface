...
{
    public class ProductSpecificationPropertyValidator : AbstractValidator<ProductSpecificationRequestProperty>
    {
        public ProductSpecificationPropertyValidator()
        {
            ...
            //RuleFor(m => m.Crit).NotEmpty().WithMessage("El campo Crit en las properties debe ser obligatorio");
            //RuleFor(m => m.LowValue).NotEmpty().WithMessage("El campo LowValue en las properties debe ser obligatorio");
            //RuleFor(m => m.HighValue).NotEmpty().WithMessage("El campo HighValue en las properties debe ser obligatorio");
        }
    }
}
